...
#define parameter_mode    10//0为测试1为参数//参数3，4开始为控制周期6ms的//参数5四元数解算参数//8速度较慢稳定//9速度中等稳定性比较稳，偶尔会失控//10速度较快，不稳定（在调整）
...
#define mpu_gyro_integral_limit 600//积分限幅参数
...
#define speed_output_limit 1100
#define speed_up_limit 50
#define speed_integral_limit 300//积分上限
int speed_val_I=180;
int speed_val_P=180;
...
//void way_judge(void)
//{
//  if((middle_Line-theory_middle_line)>8&&(middle_Line-theory_middle_line)<-8)//中线判断
//  {
//    else if()
//  }
//  else if()
