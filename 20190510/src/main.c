...
#define offset_option 1//零飘采集并去除
...
//    NVIC_SetPriorityGrouping(6);
    ...
    ftm_quad_init(ftm2);
    OLED_Init();
//    OLED_P8x16Str(0,0,"mpuinit-ing...");
//    OLED_P8x16Str(0,32,"don't touch");
//    OLED_P8x16Str(64,32,"by noir");
...
#if offset_option==1
    systick_delay_ms(1000);//延时1秒，防止mpu6050刚开机完的抖动影响零飘采集
    MPU6050_zero_drift();//采集零飘
#endif 
...
//  InitMPU6050();
//  uart_init (uart0, 115200);                          //初始换串口
//    ftm_pwm_init(ftm3,ftm_ch0,10*1000,200);
//   ftm_pwm_init(ftm3,ftm_ch1,10*1000,0);
//   ftm_pwm_init(ftm3,ftm_ch2,10*1000,200);
//   ftm_pwm_init(ftm3,ftm_ch3,10*1000,0);
