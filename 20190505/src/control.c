...
//角度环通过PD参数整定
#define static_angle_D  0.016//-8.4//-12.0//-1.0//-0.5//-32.0//-1.0//14.2//14.2//11.2//19.2//9.1//18.4//31.6//-12.0
#define left_deal_val   0  
#define right_deal_val  0
//#define static_down_angle_P  42
#define static_angle_P  0.112//0.064//0.098//0.143//-48//-12//42//78//88//108//112//122//142
float balance_angle=-31.0;//34.8;//34.4//-20.7;//-37.4;//机械零点角度 44.8~47//39//35-38大约36//35.4//33.4平衡角度//前进时角度增加
#define angle_output_limit 1100

//速度环通过PI控制//未加加速限幅加速不稳定，容易过冲//纯P控制（容易过冲震荡）（不够稳定）(速度晃动较大)
#define speed_P  -1.6//-0.98//171//4.8//32.4//-48.6
...
//角速度环PD参数整定
#define static_angle_speed_P   3.8//6.8//34//58//102//64
#define static_angle_speed_I   -0.00
#define static_angle_speed_D  -0.0//-12
#define mpu_gyro_integral_limit 110//积分限幅参数

//角度环通过PD参数整定
#define static_angle_D  -0.064//-8.4//-12.0//-1.0//-0.5//-32.0//-1.0//14.2//14.2//11.2//19.2//9.1//18.4//31.6//-12.0
#define left_deal_val   0  
#define right_deal_val  0
//#define static_down_angle_P  42
#define static_angle_P  0.164//0.064//0.098//0.143//-48//-12//42//78//88//108//112//122//142
float balance_angle=-33.8;//34.8;//34.4//-20.7;//-37.4;//机械零点角度 44.8~47//39//35-38大约36//35.4//33.4平衡角度//前进时角度增加
#define angle_output_limit 1100

//速度环通过PI控制
#define speed_P  -1.2//171//4.8//32.4//-48.6
#define speed_I  -0
#define speed_D  -0//76
#define speed_destination 0//车模期望速度-为电池方向
#define speed_curve_destination 0//车模转弯的期望速度
...
//    speed_measure();//编码器数值处理
    ...
    {         
        OLED_Print_Num1(76,0,(int)middle_encoder_val);
...
void speed_measure(void)////未完成
{
  ...
  else if(left_motor_crazy_flag)//左电机疯转处理
  {
  ...
  else if(right_motor_crazy_flag)
  {
