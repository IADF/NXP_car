...
//直立PID参数
//角速度环PD参数整定
#define static_angle_speed_P   4.2//6.8//34//58//102//64
...
#define static_angle_P  0.134//0.098//0.143//-48//-12//42//78//88//108//112//122//142
float balance_angle=-34.4;//34.8;//34.4//-20.7;//-37.4;//机械零点角度 44.8~47//39//35-38大约36//35.4//33.4平衡角度//前进时角度增加
#define angle_output_limit 450

//速度环通过PI控制
#define speed_P  16.4//4.8//32.4//-48.6
#define speed_I  0.00
#define speed_D  0
...
void PIT0_IRQHandler(void)//2ms角度环
{
    ...
    { 
        ...
        middle_speed_val=middle_speed_val*0.7+(middle_speed_val-speed_val_P)*0.3;
