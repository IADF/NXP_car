...
#define parameter_mode 5 //0为测试1为参数//参数3，4开始为控制周期6ms的//参数5四元数解算参数
...
//PWM限制//转速限制
//转速过快容易导致主控电压不足
#define PWM_limit   950 //给1000时为100%PWM输出，当电机全速输出时电机分压过大容易导致主控电压不足
...
//角速度环PD参数整定
#define static_angle_speed_P  0
#define static_angle_speed_D  0

//角度环通过PD参数整定
#define static_angle_D  -0//-38//-64//48//-68.0//-12.0//-1.0//-0.5//-32.0//-1.0//14.2//14.2//11.2//19.2//9.1//18.4//31.6//-12.0
#define left_deal_val   0  
#define right_deal_val  0
//#define static_down_angle_P  42
...
#define speed_I  0
#define speed_D  0
#define speed_destination 0//80//车模期望速度 
...
//角速度环为内环
#if 1
int angle_output_val,angle_speed_output_val;
float angle_last;
...
{
  angle_speed_output_val=(int)(static_angle_speed_P*(mpu_gyro_y-(float)0)+static_angle_speed_D*(mpu_gyro_float_y-last_mpu_gyro_float_y));
